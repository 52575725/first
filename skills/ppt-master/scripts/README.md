...
| Image tools | `visual_asset_planner.py`, `image_search.py`, `image_gen.py`, `analyze_images.py`, `gemini_watermark_remover.py` | [docs/image.md](./docs/image.md) |
| PPT-to-video agent | `video_director_agent.py`, `recommend_components.py`, `visual_asset_planner.py`, `ppt_to_video.py` | [docs/video-agent.md](./docs/video-agent.md) |
...
python3 scripts/image_search.py "textile recycling" --filename visual.jpg -o <project_path>/images
python3 scripts/image_gen.py "A modern futuristic workspace"
python3 scripts/image_gen.py --list-backends
python3 scripts/analyze_images.py <project_path>/images
```

PPT-to-video director:
...
python3 scripts/script_plan_to_audio.py <project_path> --force
```
